...
dataset_name = "data_set_IVa_symm_aa"
...
nfs = [1, 2, 4, 8, 12, 16, 20]

root = f"/mnt/c/Users/scana/Desktop/gpc/gpy_results/{dataset_name}/{alignment}_align/ard_{ard_flag}/kernel_{kernel_type.lower()}/"
n_data, k_fold = 168, 4
...
for mode in os.listdir(root):
    ...
    if mode   == 'spatialFilter_trainable': key = 'W'
    elif mode == 'spatialFilter_fixed'    : key = 'CSP'
