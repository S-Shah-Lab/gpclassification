    ...
    for random_state in random_states:
        ...
        for nf in nfs:
            runner = GPClassificationRunner(
                ...
                # Run naming / Logging
                results_dir=f"/mnt/c/Users/scana/Desktop/gpc/results/{data["dataset_label"]}/spatialFilter/seed_{spatialFilter_init}/split_{train_split}/nf_{nf}",
                run_name=None,
            )
            runner.run()
